...
const SLIDES: GuideSlide[] = [
  {
    ...
    gradient: ['rgba(26,138,126,0.55)', 'rgba(15,107,98,0.65)', 'rgba(6,74,68,0.78)'],
    accentColor: '#B3E0DA',
  ...
  },
  {
    ...
    gradient: ['rgba(15,107,98,0.5)', 'rgba(6,74,68,0.62)', 'rgba(3,45,41,0.75)'],
    accentColor: '#80CBC1',
  ...
  },
  {
    ...
    gradient: ['rgba(225,112,85,0.5)', 'rgba(253,203,110,0.55)', 'rgba(225,112,85,0.72)'],
    accentColor: '#FFECD2',
  ...
  },
  {
    ...
    gradient: ['rgba(24,40,72,0.52)', 'rgba(75,108,183,0.58)', 'rgba(24,40,72,0.75)'],
    accentColor: '#A8C0FF',
  ...
  },
  {
    ...
    gradient: ['rgba(26,138,126,0.5)', 'rgba(0,206,201,0.55)', 'rgba(6,74,68,0.72)'],
    accentColor: '#DDFFF9',
  ...
  },
  {
    ...
    gradient: ['rgba(108,92,231,0.5)', 'rgba(162,155,254,0.55)', 'rgba(108,92,231,0.72)'],
    accentColor: '#DCD6F7',
  ...
  },
  {
    ...
    gradient: ['rgba(45,52,54,0.5)', 'rgba(99,110,114,0.58)', 'rgba(45,52,54,0.72)'],
    accentColor: '#B2BEC3',
  ...
  },
  {
    ...
    gradient: ['rgba(225,112,85,0.5)', 'rgba(253,203,110,0.52)', 'rgba(225,112,85,0.7)'],
    accentColor: '#FFECD2',
  ...
  },
  {
    ...
    gradient: ['rgba(24,40,72,0.52)', 'rgba(75,108,183,0.55)', 'rgba(24,40,72,0.72)'],
    accentColor: '#A8C0FF',
  ...
  },
  {
    ...
    gradient: ['rgba(108,92,231,0.5)', 'rgba(162,155,254,0.52)', 'rgba(108,92,231,0.72)'],
    accentColor: '#DCD6F7',
  ...
  },
  {
    ...
    gradient: ['rgba(45,52,54,0.5)', 'rgba(99,110,114,0.55)', 'rgba(45,52,54,0.72)'],
    accentColor: '#DFE6E9',
  ...
  },
  {
    ...
    gradient: ['rgba(0,184,148,0.5)', 'rgba(0,206,201,0.52)', 'rgba(0,184,148,0.7)'],
    accentColor: '#DDFFF9',
  ...
  },
  {
    ...
    gradient: ['rgba(26,138,126,0.52)', 'rgba(15,107,98,0.58)', 'rgba(6,74,68,0.72)'],
    accentColor: '#B3E0DA',
  ...
  },
  {
    ...
    gradient: ['rgba(24,40,72,0.5)', 'rgba(75,108,183,0.55)', 'rgba(24,40,72,0.72)'],
    accentColor: '#A8C0FF',
  ...
  },
  {
    ...
    gradient: ['rgba(45,52,54,0.5)', 'rgba(99,110,114,0.52)', 'rgba(45,52,54,0.72)'],
    accentColor: '#DFE6E9',
  ...
  },
  {
    ...
    secondaryIcon: 'eye',
    title: 'Browse\nMode',
    subtitle: 'Your public Command Center — clients explore everything before signing up.',
    bullets: [
      'Anyone can browse listings, features, and tools — no login required',
      'The cinematic video hero landing page showcases your brand',
      'Clients see the full platform before committing to an account',
      'Browse Mode builds trust and drives sign-ups organically',
    ],
    gradient: ['rgba(26,138,126,0.5)', 'rgba(0,206,201,0.52)', 'rgba(6,74,68,0.7)'],
    accentColor: '#DDFFF9',
    image: require('@/assets/images/guide-browse.jpg'),
    badge: 'PUBLIC ACCESS',
  },
  {
    id: 'ecosystem',
    ...
    secondaryIcon: 'shield-checkmark',
    title: 'Ecosystem\nLogin',
    subtitle: 'One identity across every DarkWave app — Trust Layer verified.',
    bullets: [
      'Sign in with your Trust Layer ID or email from any DarkWave app',
      'Pre-verified members from Happy Eats, Signal, TrustVault, or Verdara',
      'Ecosystem PIN or full password — your choice for quick access',
      'Your Trust Score and membership travel across the entire network',
    ],
    gradient: ['rgba(24,40,72,0.5)', 'rgba(75,108,183,0.55)', 'rgba(24,40,72,0.72)'],
    accentColor: '#A8C0FF',
    image: require('@/assets/images/guide-ecosystem.jpg'),
    badge: 'TRUST LAYER ECOSYSTEM',
  },
  {
    id: 'ready',
    icon: 'rocket',
    ...
    bullets: [
      'Your public Command Center lets clients explore before signing up',
      'Social media links display in the footer — profiles added during setup',
      'Access this tour anytime from the hamburger menu',
      'Your data is secure, verified, and backed by the DarkWave Trust Layer',
    ],
    gradient: ['rgba(26,138,126,0.52)', 'rgba(15,107,98,0.58)', 'rgba(6,74,68,0.72)'],
    accentColor: '#B3E0DA',
